...
pub struct CodegenCx<'tcx> {
    ...
    pub internal_buffer_load_volatile_id: RefCell<FxHashSet<Word>>,
    pub internal_buffer_store_id: RefCell<FxHashSet<Word>>,
    pub internal_buffer_store_volatile_id: RefCell<FxHashSet<Word>>,
    ...
    pub internal_uint_atomic_i_add_id: RefCell<FxHashSet<Word>>,
    pub internal_uint_atomic_or_id: RefCell<FxHashSet<Word>>,
    pub internal_uint_atomic_exchange_id: RefCell<FxHashSet<Word>>,
...
impl<'tcx> CodegenCx<'tcx> {
    pub fn new(tcx: TyCtxt<'tcx>, codegen_unit: &'tcx CodegenUnit<'tcx>) -> Self {
        ...
        let result = Self {
            ...
            internal_buffer_load_volatile_id: Default::default(),
            internal_buffer_store_id: Default::default(),
            internal_buffer_store_volatile_id: Default::default(),
            ...
            internal_uint_atomic_i_add_id: Default::default(),
            internal_uint_atomic_or_id: Default::default(),
            internal_uint_atomic_exchange_id: Default::default(),
